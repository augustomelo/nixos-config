{ pkgs, lib, ... }: 
{
  home.activation.zshActivation = lib.hm.dag.entryAfter ["writeBoundary"] ''
    (
      ...
      $DRY_RUN_CMD ${pkgs.curl}/bin/curl -o "$completion_folder/_fd" https://raw.githubusercontent.com/sharkdp/fd/refs/heads/master/contrib/completion/_fd
      $DRY_RUN_CMD ${pkgs.curl}/bin/curl -o "$completion_folder/_fzf" https://raw.githubusercontent.com/junegunn/fzf/refs/heads/master/shell/completion.zsh
      $DRY_RUN_CMD ${pkgs.curl}/bin/curl -o "$completion_folder/_git" https://raw.githubusercontent.com/git/git/refs/heads/master/contrib/completion/git-completion.zsh
      $DRY_RUN_CMD ${pkgs.curl}/bin/curl -o "$completion_folder/_home-manager" https://raw.githubusercontent.com/nix-community/home-manager/refs/heads/master/home-manager/completion.zsh
      $DRY_RUN_CMD ${pkgs.curl}/bin/curl -o "$completion_folder/_hurl" https://raw.githubusercontent.com/Orange-OpenSource/hurl/refs/heads/master/completions/_hurl
